...
function fillInDataToTable() {
  var elementTable = document.getElementsByTagName('table');
  var tableBody = document.createElement('tbody');
  elementTable[0].appendChild(tableBody);
  console.log(data.users.length);
  var dataLength = data.users.length;
...
var elementButton = document.getElementById('fill-in-data');
elementButton.addEventListener('click', fillInDataToTable);